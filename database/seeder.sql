...
INSERT INTO product(categoryId, SKU, title, brand, price, shortDescription, description, image, enabled, featured,
                    viewCount)
...
INSERT INTO category(parentId, code, title, description)
